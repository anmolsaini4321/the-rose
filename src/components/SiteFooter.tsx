      ...
      <div className="mx-auto max-w-[1600px] px-6 lg:px-12 py-24">
        <div className="grid gap-16 lg:grid-cols-12">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3 text-sm opacity-90">
              <li><Link to="/shop" className="hover:opacity-70">Browse Bouquets</Link></li>
              ...
              <li><Link to="/cart" className="hover:opacity-70">Your Bag</Link></li>
              <li><Link to="/orders" className="hover:opacity-70">My Orders</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-24 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between gap-4 text-xs opacity-60">
          ...
          <div className="flex gap-6">
            ...
            <Link to="/orders" className="hover:opacity-100">Orders</Link>
            <Link to="/auth" className="hover:opacity-100">Account</Link>
          </div>
        </div>
      </div>
    </footer>
